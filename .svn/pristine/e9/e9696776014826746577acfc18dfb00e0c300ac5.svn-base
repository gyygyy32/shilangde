...
namespace Reader
{
    public delegate void UHFReciveDataCallback(byte[] btAryReceiveData);
    public delegate void UHFSendDataCallback(byte[] btArySendData);
    public delegate void UHFAnalyDataCallback(UHFMessageTran msgTran);

    public class UFHReader 
    {
        private SerialPort iSerialPort;
        private int m_nType = -1;

        public UHFReciveDataCallback ReceiveCallback;
        ...
        private void RunReceiveDataCallback(byte[] btAryReceiveData)
        {
            try
            {
                    ...
                    if (btAryBuffer.Length > nLoop + 1)
                    {
                        if (btAryBuffer[nLoop] == 0xA0)
                        {
                            ...
                            if (nLoop + 1 + nLen < btAryBuffer.Length)
                            {
                                ...
                                UHFMessageTran msgTran = new UHFMessageTran(btAryAnaly);
                ...
                //larry 2017/4/12 strange here, should test here
        ...
        {
            UHFMessageTran msgTran = new UHFMessageTran(btReadId, btCmd);
        ...
        {
            UHFMessageTran msgTran = new UHFMessageTran(btReadId, btCmd, btAryData);
        ...
        {
            UHFMessageTran msgTran = new UHFMessageTran();
