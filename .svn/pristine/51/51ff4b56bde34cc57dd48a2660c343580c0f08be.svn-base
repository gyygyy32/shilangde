...
namespace Reader
{
    public class UHFMessageTran
    {
        ...
        public UHFMessageTran()
        {

        }

        public UHFMessageTran(byte btReadId, byte btCmd, byte[] btAryData)
        {
         ...
         */
        public UHFMessageTran(byte btReadId, byte btCmd)
        {
            this.btPacketType = 0xA0;
            this.btDataLen = 0x03;
            this.btReadId = btReadId;
         ...
         */
        public UHFMessageTran(byte[] btAryTranData)
        {
